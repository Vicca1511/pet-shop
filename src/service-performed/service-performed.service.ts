...
export class ServicePerformedService {
  ...
  async findOne(id: string) {
    const alreadyPerformedList = this._serviceperformed.find((servicePerformed) => servicePerformed.id === id);
    return alreadyPerformedList
  }

  async update(id: string, updateServicePerformedDto: UpdateServicePerformedDto) {
...
function update(id: string, updateServicePerformedDto: any, UpdateServicePerformedDto: UpdateServicePerformedDto) {
  throw new Error('Function not implemented.');
}
